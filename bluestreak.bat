...
"C:\cmake-3.31.8\bin\ctest.exe" -S "C:\D\DashboardScripts\bluestreak-vs2022-slicer_preview_nightly.cmake" -C Release -VV -O C:\D\Logs\bluestreak-vs2022-slicer_preview_nightly.txt
...
"C:\cmake-3.31.8\bin\ctest.exe" -S "C:\D\DashboardScripts\bluestreak-vs2022-slicerextensions_preview_nightly.cmake" -C Release -VV -O C:\D\Logs\bluestreak-vs2022-slicerextensions_preview_nightly.txt
EXIT /B 0
